...
export default function HomePage() {
  return (
    <Layout>
      ...
      <div
        data-aos="fade-up"
        className="flex flex-col lg:flex-row items-center justify-between mt-8 p-6 lg:p-8"
      >
        {/* Text */}
      ...
      <div
        data-aos="fade-up"
        className="mt-8 bg-[#E0E6D8] rounded-2xl p-6 lg:p-8 shadow-sm"
      >
        {/* Title */}
      ...
      <div data-aos="fade-up" className="fixed bottom-6 right-6">
        <Link
          to="/chatbot"
          className="w-14 h-14 bg-[#388E3C] rounded-full shadow-lg hover:scale-110 transition flex items-center justify-center"
        >
