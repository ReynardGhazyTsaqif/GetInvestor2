...
import { QrCode, DollarSign, ShoppingBag, MapPin, MessageCircle } from "lucide-react";
    ...
    <Layout>
      ...
      <div data-aos="fade-up" className="flex flex-col lg:flex-row items-center justify-between mt-8 p-6 lg:p-8">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <img src={HomeImage} alt="Eco Banner" className="max-w-sm lg:max-w-md" />
        </div>
      </div>
      ...
      <div data-aos="fade-up" className="mt-8 bg-[#E0E6D8] rounded-2xl p-6 lg:p-8 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-gray-800">Scan & Dapatkan Point</h3>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-gray-800">Cari Lokasi Penukaran</h3>
          </div>
        </div>
      </div>
